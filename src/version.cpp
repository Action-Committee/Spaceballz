...
// Copyright (c) 2014 The spaceballz developers
...
// for both spaceballzd and spaceballz(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of spaceballz releases, the client name should be selected from
