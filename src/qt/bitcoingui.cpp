...
{
    resize(850, 550);
    setWindowTitle(tr("spaceballz Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/spaceballz_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/spaceballz_tooltip"), tr("&About spaceballz"), this);
    ...
    toggleHideAction = new QAction(QIcon(":/icons/spaceballz_tooltip"), tr("Show/Hide &spaceballz"), this);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/spaceballz_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/spaceballz_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/spaceballz_tooltip"));
            }
        }
